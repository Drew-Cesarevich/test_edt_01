...
Процедура СоздатьКонтейнерИЗапросНаСертификатПослеПолучения(ДлительнаяОперация, ВходящийКонтекст) Экспорт
	...
	Если Результат.Выполнено Тогда
		...
		КонецЕсли;
	Иначе
		РезультатВыполнения = СоздатьКонтейнерИЗапросНаСертификатРезультат(Ложь, ОбработкаОшибок.ПодробноеПредставлениеОшибки(Результат.ИнформацияОбОшибке));
	КонецЕсли;
...
Процедура УстановитьСертификатВКонтейнерИХранилищеПослеВыполнения(ДлительнаяОперация, ВходящийКонтекст) Экспорт
	...
	Если Результат.Выполнено Тогда
		...
		КонецЕсли;
	Иначе
		РезультатВыполнения = УстановитьСертификатВКонтейнерИХранилищеРезультат(Ложь, ОбработкаОшибок.ПодробноеПредставлениеОшибки(Результат.ИнформацияОбОшибке));
	КонецЕсли;
