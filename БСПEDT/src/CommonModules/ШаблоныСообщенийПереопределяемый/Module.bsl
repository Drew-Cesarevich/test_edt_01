...
Процедура ПриНачальномЗаполненииЭлементов(КодыЯзыков, Элементы, ТабличныеЧасти) Экспорт
	...
	// _Демо начало примера
	_ДемоОбновлениеИнформационнойБазыБСП.ПриНачальномЗаполненииШаблоновСообщений(КодыЯзыков, Элементы, ТабличныеЧасти);
	// _Демо конец примера
...
Процедура ПриНачальномЗаполненииЭлемента(Объект, Данные, ДополнительныеПараметры) Экспорт
	...
	// _Демо начало примера
	_ДемоОбновлениеИнформационнойБазыБСП.ПриНачальномЗаполненииЭлементаШаблоновСообщений(Объект, Данные, ДополнительныеПараметры);
	// _Демо конец примера
