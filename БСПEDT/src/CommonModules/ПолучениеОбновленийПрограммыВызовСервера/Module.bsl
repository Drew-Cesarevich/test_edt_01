...
// Возвращает сохраненные настройки обновления в хранилище общих настроек.
//
// Возвращаемое значение:
//  Структура:
//    * РежимАвтоматическойПроверкиНаличияОбновленийПрограммы - Число - режим автоматической проверки наличия
//      обновлений. Допустимые значения:
//        1 - при запуске программ. Режим по умолчанию.
//        2 - по расписанию.
//        3 - не проверять автоматически.
...
// * РежимУстановки - Число - режим установки платформы. Допустимые значения:
