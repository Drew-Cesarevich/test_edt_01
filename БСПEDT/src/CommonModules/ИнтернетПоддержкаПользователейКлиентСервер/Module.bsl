...
// Параметры:
//  Текст - Строка
//  ДоменнаяЗона - Неопределено - домен не корректируется.
//               - Число - числовой код доменной зоны. Доступные значения:
//                   1 - европейский домен.
//
// Возвращаемое значение:
//  Строка
...
//
// Параметры:
//  ТекстСообщения - Строка - строка для преобразования.
//
// Возвращаемое значение:
//  Строка
//
...
//
Функция ЛогинСодержитНеДопустимыеСимволы(Логин) Экспорт
