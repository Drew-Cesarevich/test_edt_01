	...
	Для каждого СтрокаТаблицы Из ЗагружаемыеДанные Цикл
		...
		Попытка
			...
			Иначе
				...
				ЗагрузкаДанныхИзФайла.ЗагрузитьЗначенияСвойствИзФайла(ЭлементСправочника.Ссылка, СтрокаТаблицы);
...
Функция ПолучитьБлокируемыеРеквизитыОбъекта() Экспорт
	...
	Реквизит.Предупреждение =
		НСтр("ru = 'Не рекомендуется изменять, если номенклатура уже используются'");
