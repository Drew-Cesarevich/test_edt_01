...
Функция ПроверитьНаличиеОбновленияВФоновомРежиме(Параметры) Экспорт
...
//    * ДоступноОбновление - Булево - Истина, если доступно обовление для установки.
//    * Сценарий - Строка - идентификатор сценария обновления программы.
//    * Конфигурация - Неопределено, Структура - информация о новых конфигурациях.
//    * Платформа - Неопределено, Структура - информация о новой платформе 1С.
//    * Исправления - Неопределено, ТаблицаЗначений - информация о новых исправлениях.
//
