...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОбщегоНазначенияКлиентСервер.СравнитьВерсии(ВерсияБСП, "3.1.7.404") < 0
	 Или ОбщегоНазначенияКлиентСервер.СравнитьВерсии(ВерсияБСП, "3.1.8.0") > 0
	   И ОбщегоНазначенияКлиентСервер.СравнитьВерсии(ВерсияБСП, "3.1.8.302") < 0 Тогда
		
		РегистрыДляУдаления = Новый Массив;
		РегистрыДляУдаления.Добавить("АдресныеОбъекты");
		РегистрыДляУдаления.Добавить("ДомаЗданияСтроения");
		РегистрыДляУдаления.Добавить("ДополнительныеАдресныеСведения");
		РегистрыДляУдаления.Добавить("ЗемельныеУчастки");
		РегистрыДляУдаления.Добавить("ОриентирыАдресныхОбъектов");
		РегистрыДляУдаления.Добавить("СвязиАдресныхОбъектов");
		СписокРегистров = СтрСоединить(РегистрыДляУдаления, ", ");
